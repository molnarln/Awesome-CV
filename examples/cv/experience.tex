...
%---------------------------------------------------------
  ...
  {RDI - DOTO Systems} % Organization
  {Budapest} % Location
  % {2019. augusztus - } % Date(s)
  {2020. March - 2022. January} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
      % \item {Keretrendszer paraméterezése üzleti igényeknek megfelelően (JavaScript, MySQL, MongoDB)}
      \item {Implement business solutions using .NET Framework and JavaScript}
